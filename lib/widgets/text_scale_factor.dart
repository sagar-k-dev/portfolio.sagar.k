...
class ScaleSize {
  static double textScaleFactor(
    ...
    if (kIsWeb && width < 600) {
      return _clampScale(width / 600 * maxTextScaleFactor, 1.0, 1.4);
    }
    ...
    switch (device) {
      ...
      case DeviceScreenType.tablet:
        return _clampScale(width / 1000 * maxTextScaleFactor, 0.95, 1.4);
      case DeviceScreenType.web:
        return _clampScale(width / 1200 * maxTextScaleFactor, 0.9, 1.7);
    }
  }
